...
public class signupNGTest {
    ...
    public void testSignup1() throws Exception {
        String txt = fetch("/srv/signup?user=bob&pw=password&name=Robert");
        System.out.print(txt);
        assertTrue( txt.contains("username is bob"));
        assertTrue( txt.contains("password is password"));
        assertTrue( txt.contains("your name is Robert"));
    }
    
    @Test
    public void testSignup2() throws Exception {
        String txt = fetch("/srv/signup?user=bob&pw=password");
        System.out.print(txt);
        assertTrue( txt.contains("No name provided"));
    }
    
    @Test
    public void testSignup3() throws Exception {
        String txt = fetch("/srv/signup?user=bob&name=Robert");
        System.out.print(txt);
    ...
    public void testSignup4() throws Exception {
        String txt = fetch("/srv/signup?pw=password&name=Robert");
        System.out.print(txt);
